    ...
    <SafeAreaView>
      ...
      <ScrollView>
        <View className='flex justify-center items-center mt-3'>
          ...
          {myContacts.length < 1 || active === 1
            ? (
                contactsSearched.length < 1 && active === 1
                  ? (
                  ...
                  : (
                    <ScrollView className='pt-2 pb-12 bg-appbluelight w-full px-5'>
                      {contactsSearched.map((c) => (
                        <View key={c._id} className='rounded-lg bg-appbluelight border-b border-b-appblue'>
                          <View className='flex flex-row items-center w-full bg-appbluelight px-3 py-5' key={c.lookupKey}>
