...
export default function Authors () {
  return (
    <section className='h-full bg-[#C9D7E1] flex flex-col items-center py-20'>
      <h2 className='w-2/4 text-center'>
        <b>
          Somos un equipo multidisciplinario de Programadores y Diseñadoras que
          realizamos una aplicación completamente funcional en 5 semanas.
        </b>
      </h2>
      <section className='flex flex-wrap w-[70%] gap-12 justify-center mt-10'>
        {authors.map((author) => {
          return (
            <article
              key={author.name}
