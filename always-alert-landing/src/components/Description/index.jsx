  ...
  return (
    <>
      <section className='flex flex-col lg:flex-row justify-center lg:mx-8 items-center gap-12 lg:gap-36 my-20'>
        ...
        <div data-aos='fade-left' className='lg:w-[640px] lg:h-[640px] rounded-full flex flex-col items-center justify-center bg-gradient-to-b from-gray-100 py-8 sm:py-24 sm:mt-12 to-transparent'>
          ...
          <img className='w-64 object-cover sm:w-3/4 max-w-md' src='/assets/description/character.png' alt='' />
        </div>
      </section>
      <section className='h-full flex flex-col-reverse lg:flex-row justify-center lg:mx-8 items-center gap-12 lg:gap-36 my-20'>
        <div data-aos='fade-right' className='lg:w-[640px] lg:h-[640px] rounded-full flex flex-col items-center justify-center bg-gradient-to-b from-gray-100 py-12 sm:py-24 sm:mt-12 to-transparent'>
          <h3 className='w-2/4 text-center text-xl sm:text-2xl'>
            <b>Nuestra app te ayuda</b> a infórmarle a tus contactos tu estado,
            para que estén siempre alertas.
          </h3>
          <img className='w-64 object-cover sm:w-3/4 max-w-md' src='/assets/description/character2.png' alt='' />
        </div>
