  ...
  return (
    <>
      <section className='flex flex-col lg:flex-row justify-center lg:mx-8 items-center gap-12 lg:gap-36 my-20'>
        ...
        <div className='lg:w-[640px] lg:h-[640px] rounded-full flex flex-col items-center justify-center bg-gradient-to-b from-gray-100 py-8 to-transparent'>
      ...
      <section className='h-full flex flex-col-reverse lg:flex-row justify-center lg:mx-8 items-center gap-12 lg:gap-36 my-20'>
        <div className='lg:w-[640px] lg:h-[640px] rounded-full flex flex-col items-center justify-center bg-gradient-to-b from-gray-100 py-12 to-transparent'>
          <h3 className='w-2/4 text-center text-xl sm:text-2xl'>
